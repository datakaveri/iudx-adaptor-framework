...
kubectl create clusterrolebinding flink-role-binding-flink --clusterrole=edit --serviceaccount=adaptor-framework:flink-service-account -n adaptor-framework
