...
public class TimeBasedDeduplicator implements Deduplicator {

  private static final Logger LOGGER = LogManager.getLogger(TimeBasedDeduplicator.class);

  public TimeBasedDeduplicator() {
  }
